...
abstract class BasereviewsForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'recepient_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('users'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'recepient_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('users'))),
