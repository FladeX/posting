...
/**
 * login_history form base class.
 *
 * @method login_history getObject() Returns the current form's model object
 *
 * @package    posting
 * @subpackage form
 ...
 */
abstract class Baselogin_historyForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'user_ip'    => new sfValidatorString(array('max_length' => 255)),
