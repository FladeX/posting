...
abstract class BasereportsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'posting_name'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'posting_password' => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'posting_messages' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'posting_name'     => new sfValidatorPass(array('required' => false)),
      'posting_password' => new sfValidatorPass(array('required' => false)),
      'posting_messages' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'posting_date'     => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
  ...
  public function getFields()
  {
    return array(
      ...
      'posting_name'     => 'Text',
      'posting_password' => 'Text',
      'posting_messages' => 'Number',
      'posting_date'     => 'Date',
      'status'           => 'Number',
      'created_at'       => 'Date',
      'updated_at'       => 'Date',
