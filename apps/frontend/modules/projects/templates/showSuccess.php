...
<?php slot('breadcrumbs', '<div id="breadcrumbs"><a href="' . url_for('projects/index') . '">Текущие задания</a> > </div><h2>' . $projects->getTitle() . '</h2>') ?>
...
<div id="mainContent">
	...
	<div id="sidebar">
		<div class="sidebarBlock customer">
			...
			<div><a href="<?php echo url_for('users/show?id='.$projects->getAuthorId()) ?>"><?php echo $projects->getAuthorId() ?></a></div>
